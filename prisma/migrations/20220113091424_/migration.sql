/*
  ...
  - The values [ADDED_PHOTOS] on the enum `NotificationSource` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "NotificationSource_new" AS ENUM ('LIKE_POST', 'LIKE_COMMENT', 'COMMENT', 'POST', 'JOINED_INS', 'JOIN_INS_REJECTED', 'MESSAGE', 'CHANGE_ADMIN', 'DELETED_INS', 'PENDING_INS', 'STORY', 'LIKE_STORY');
